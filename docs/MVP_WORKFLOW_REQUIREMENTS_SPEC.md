...
- Giảng viên quản lý tài liệu tri thức cho các môn học được phân công.
...
1. **Quản lý tri thức môn học**
   - Admin tạo môn học và phân công giảng viên.
...
| Teacher | Giảng viên phụ trách một hoặc nhiều môn học. Quản lý tài liệu, xem thống kê và chạy evaluation cho các môn được phân công. |
...
2. Admin phân công một hoặc nhiều giảng viên vào môn học.
...
- Admin chỉ nên xóa môn học nếu hệ thống đã xử lý cascade an toàn. Nếu chưa chắc chắn, MVP nên dùng unapprove/archive thay vì hard delete.
- Danh sách môn học nên hiển thị số lượng tài liệu nếu truy vấn đơn giản.

#### Phân Công Giảng Viên

- Admin có thể assign Teacher vào môn học.
- Admin có thể unassign Teacher khỏi môn học.
...
- Nếu cùng một môn học đã có hash tương tự:
  ...
  - hiển thị thông báo: "Tài liệu này đã tồn tại trong môn học."
...
- Xóa tài liệu phải xóa khỏi database và RAG index nếu hệ thống hỗ trợ.
- Nếu xóa khỏi RAG API thất bại, hệ thống phải log warning và báo rõ nếu tài liệu có thể vẫn còn searchable.
