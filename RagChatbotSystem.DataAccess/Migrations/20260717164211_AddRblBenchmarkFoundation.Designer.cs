...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.BenchmarkDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.BenchmarkQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RelevantChunkIdsJson")
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("BenchmarkDefinitionId", "SortOrder")
                        .IsUnique();
            ...
            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.EvaluationEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EvaluationResultId", "Rank")
                        .IsUnique();

                    b.ToTable("EvaluationEvidence");
                });

            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.EvaluationProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("EnableRerank")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsEnabled")
                        .HasColumnType("boolean");

                    b.Property<double>("LexicalWeight")
                        .HasColumnType("double precision");
                    ...
                    b.ToTable("EvaluationProfiles");
                });

            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.EvaluationResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("BenchmarkQuestionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BenchmarkQuestionId");

                    b.HasIndex("EvaluationRunId", "BenchmarkQuestionId")
                        .IsUnique();

                    b.ToTable("EvaluationResults");
                });

            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.EvaluationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("EvaluationProfileId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EvaluationProfileId");

                    b.HasIndex("RunByUserId");

                    b.HasIndex("DatasetId", "CreatedAt");

                    b.HasIndex("BenchmarkDefinitionId", "EvaluationProfileId", "CreatedAt");
            ...
            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.BenchmarkQuestion", b =>
                {
                    b.HasOne("RagChatbotSystem.DataAccess.Models.BenchmarkDefinition", "BenchmarkDefinition")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.EvaluationEvidence", b =>
                {
                    ...
                    b.HasOne("RagChatbotSystem.DataAccess.Models.EvaluationResult", "EvaluationResult")
                        .WithMany("Evidence")
            ...
            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.EvaluationResult", b =>
                {
                    b.HasOne("RagChatbotSystem.DataAccess.Models.BenchmarkQuestion", "BenchmarkQuestion")
                        .WithMany("Results")
                        .HasForeignKey("BenchmarkQuestionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RagChatbotSystem.DataAccess.Models.EvaluationRun", "EvaluationRun")
                        .WithMany("Results")
            ...
            modelBuilder.Entity("RagChatbotSystem.DataAccess.Models.EvaluationRun", b =>
                {
                    ...
                    b.HasOne("RagChatbotSystem.DataAccess.Models.EvaluationProfile", "EvaluationProfile")
                        .WithMany("Runs")
                        .HasForeignKey("EvaluationProfileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("EvaluationProfile");
