...
namespace RagChatbotSystem.Business.Interfaces
{
    public interface IDocumentService
    {
        ...
        Task<DocumentDto> UploadDocumentAsync(Guid datasetId, Guid userId, Stream fileStream, string fileName, long fileSize, bool overwriteExistingFileName = false, CancellationToken cancellationToken = default);
